...
echo -e "\033[1;32m $(fun_trans  "              INSTALADOR SSL By VPS-BO")"
msg -bar
...
msg -bar
 ...
 sleep 3  
 screen -dmS pydic-80 python ${SCPinst}/python.py 80 "VPS-BO" && echo "80 VPS-BO" >> /etc/VPS-BO/PySSL.log
 msg -bar
 } 
 install_ssl(){  
