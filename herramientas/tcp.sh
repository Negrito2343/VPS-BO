...
export PATH
SCPfrm="/etc/VPS-BO/herramientas" && [[ ! -d ${SCPfrm} ]] && mkdir ${SCPfrm}
BARRA1="\e[0;31m————————————————————————————————————————————————————\e[0m"
SCPinst="/etc/VPS-BO/controlador" && [[ ! -d ${SCPfrm} ]] && mkdir ${SCPfrm}
#=================================================
...
msg -bar
msg -tit
echo -e "    TCP Aceleración (BBR/Plus) VPS-BO By @Kalix1\n                         ${Red_font_prefix}[v${sh_ver}]${Font_color_suffix}
$(msg -bar)
